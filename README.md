...
| ![Proficient](https://img.shields.io/badge/PROFICIENT-2563EB?style=for-the-badge) | AI의 보조 없이 기능 구현 과정에서 기술을 활용하거나, 발생한 문제를 스스로 트러블슈팅할 수 있는 수준 |
| ![Intermediate](https://img.shields.io/badge/INTERMEDIATE-F59E0B?style=for-the-badge) | 프로젝트에 기술을 적용해본 경험이 있거나, 공식 문서와 AI 등을 활용하여 필요한 기능을 완성할 수 있는 수준 |
...
- Redis & AOP 기반 예약 동시성 제어 로직 구현 및 개선 작업
- DDD 기반 프로젝트 수행 경험: DDD 기반 주문/배송 도메인 로직 구현 및 이벤트를 활용한 전체 주문 프로세스 구현
- MSA 서비스 인프라 구축 & PLG 스택 기반 모니터링 진행 및 트래픽 처리량 개선 경험(API 게이트웨이)
- k6 기반 테스트 시나리오 설계 및 부하테스트 진행
